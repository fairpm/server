...
class Nav_Walker extends \Walker_Nav_Menu {
  ...
  public function start_lvl( &$output, $depth = 0, $args = null ) {
    ...
    if ( isset( $args->has_dropdown ) && $args->has_dropdown ) {
      ...
      $icon = ob_get_clean();
      $output .= '<button class="dropdown-toggle" aria-expanded="false" aria-label="' . __( 'Open child menu', 'fair-parent-theme' ) . '">';
      $output .= $icon . '</button>';
  ...
  public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
    ...
    $output .= apply_filters( 'walker_nav_menu_start_el', $item_output, $item, $depth, $args );
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="menu-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'fair-parent-theme' ) . '">' . esc_html__( 'Add a menu', 'fair-parent-theme' ) . '</a></li>';
			$fallback_output .= '</ul>';
